  ...
  return (
    <>
      ...
      >
        <div className="features-heading-container">
          <div className="features-container">
            <div className="features-container1">
              <h1 className="features-text Section-Heading">{props.heading}</h1>
            </div>
            ...
            <div className="features-container3"></div>
          </div>
          <span className="features-text1 Section-Text">{props.Text}</span>
        </div>
        ...
        <div className="features-cards-container1">
          <FeatureCard
